...
public class MerchantAddress {
	...
	public MerchantAddress(int addressId, @NotNull(message = "Adsress cannot be Blank") String name,
			@NotNull(message = "Street cannot be Blank") String streetAddress,
			@NotNull(message = "City cannot be Blank") String city,
			@NotNull(message = "State cannot be Blank") String state,
			@NotNull(message = "zipcode cannot be Blank") long zipCode,
			@NotNull(message = "Country cannot be Blank") String country) {
		super();
		this.addressId = addressId;
		this.name = name;
		this.streetAddress = streetAddress;
